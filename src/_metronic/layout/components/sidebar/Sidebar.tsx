...
import {SidebarLogo1} from './SidebarLogo1'
...
const Sidebar = () => {
  ...
  return (
    <div id='kt_app_sidebar' className={clsx('app-sidebar', config.app?.sidebar?.default?.class)} style={{ margin: '0.5rem', borderRadius: "3rem"}}>
      <SidebarLogo1 />
